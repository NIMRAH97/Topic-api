...
public class TopicTests {
	...
	public void getTopicTest() {
		...
		Assert.assertEquals("Spring Framework" , service.getTopic("Spring").get().getName());
		Assert.assertEquals("Spring Framework Description", service.getTopic("Spring").get().getDescription());
	}
